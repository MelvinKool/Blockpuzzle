...
public class Blockpuzzle {
    ...
    static List<int[]> pinPositions = new ArrayList<>();
     ...
     * @param pinNR 
     */
    public static void placePin(List<int[]> positions, int pinNR){
     ...
     * @return 
     */
    public static boolean testGrid(int[][] grid, int[][] shape, int y, int x){
        for(int[] pos : shape){
            try{
     ...
     * @return 
     */
    public static int[][] putInGrid(int[][] grid, int[][] shape, int y, int x, int blockNR){
        for(int[] pos : shape){
     ...
     * @return 
     */
    public static int[][] copyAndClearGrid(int[][] oldGrid, boolean clear, int blockNR){
     ...
     * @param grid 
     */
    public static void addToSolutions(int[][] grid){
     ...
     * @param blockNR 
     */
    public static void solve(int[][] grid, List<Block> blocks, int blockNR){
        int newBlockNR;
        if(blockNR == 9){
            /*
            for(int[] p : grid){
